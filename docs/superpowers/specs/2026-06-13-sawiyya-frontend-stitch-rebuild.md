...
| home       | `screens/Home.tsx`                                           | the-journey-home--_, sawiyya-together-as-equals--_                                                                                       |
| firstSign  | `screens/FirstSign.tsx`, `components/SignDemo.tsx`           | first-sign-watch-demo--_, first-sign-watch-i-love-you--mobile, celebration-connection-made--_                                            |
...
| allSigns   | `screens/AllSigns.tsx`                                       | practise-the-alphabet--_, all-signs--_                                                                                                   |
...
| info       | `screens/InfoPages.tsx`                                      | privacy--_, how-the-ai-works--_                                                                                                          |
