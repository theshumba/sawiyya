...
_(Only if the owner opts into the design's exact wording — Home tab reading "Home"/"الرئيسية" instead of "Learn"/"تعلّم", and AR "تمرين"/"الإشارات"/"التقدّم" — would you edit those existing values in place. That is a copy change, not a new key, and is NOT part of the reskin.)_
