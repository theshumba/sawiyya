...
for (const rel of files) {
  ...
  writeFileSync(f, buf);
  console.log(
    `cleaned ${basename(f)}  ${out.w}x${out.h}  bg-removed ${out.removedPct}%  (${out.clusters} bg clusters)`,
  );
}
