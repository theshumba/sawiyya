...
const dict = {
  ...
  famLeagueNote: { en: "We celebrate everyone — no rankings, no losers. Turn on friendly league in settings.", ar: "نحتفي بالجميع — لا ترتيب ولا خاسرين. فعّل الدوري الودّي من الإعدادات." },
